...
export const zh = {
  ...
  installConfirmDesc: '启用后以下能力将注入当前会话。请确认来源可信，详情可查看插件卡片。',
  installAndEnable: '确认安装',
  installConfirmNoSurfaces: '该套件未声明任何运行时能力。',
  installConfirmExecutable: '风险提示：启用后将启动该套件的 MCP 子进程并挂载 hooks（第三方代码）。请确认来源可信后再启用。',
...
export const en: Record<LocaleKey, string> = {
  ...
  installConfirmDesc: 'Once enabled, the surfaces below inject into your sessions. Confirm you trust the source; see the suite card for details.',
  installAndEnable: 'Install',
  installConfirmNoSurfaces: 'This suite declares no runtime surfaces.',
  installConfirmExecutable: 'Risk notice: enabling starts this suite\'s MCP child processes and mounts hooks (third-party code). Enable only if you trust the source.',
