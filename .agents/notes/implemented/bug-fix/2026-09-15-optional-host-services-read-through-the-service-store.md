...
Supersession: the timer paragraph of [the settings note](../../implemented/architecture/2026-09-13-settings-and-card-ride-the-host.md) records the same trap for the timer accessors. That note stays authoritative for the settings, card and timer decisions; neither note supersedes the other.
