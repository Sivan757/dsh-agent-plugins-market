...
- `node scripts/compat-report.mjs` — nine samples, all schema-valid, three `integrated` and six `shadowed`, written to `docs/reference/compat-report.json` and `docs/reference/compat-report.md`.
